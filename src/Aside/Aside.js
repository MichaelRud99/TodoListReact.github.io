...
const Aside = () => {
  return (
    <aside>
      ...
      <p className="aside__subtitle">Vanilla JavaScript Example
        <a href="https://github.com/monsegard/monsegard1.github.io" className="link">Source</a>
      </p>
      <hr className="aside__hr"></hr>
      <blockquote className="quote speech-bubble">
        <p className="quote__p italic">JavaScript® (often shortened to JS) is a lightweight,
          interpreted, object-oriented language with first-class functions,
          most known as the scripting language for Web pages,
          but used in many non-browser environments as well such as node.
